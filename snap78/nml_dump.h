...
void dump_lit(const Lit_Value lit);

void dump_lit_pretty(const Lit_Value lit);
...
void dump_expr_constr(const Expr_Constr *node, uint32_t depth, bool last);

void dump_expr_tuple(const Expr_Tuple *node, uint32_t depth, bool last);

void dump_expr_lit(const Expr_Lit *node, uint32_t depth, bool last);
...
void dump_patn_lit(const Patn_Lit *node, uint32_t depth, bool last);
