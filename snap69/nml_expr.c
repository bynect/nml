...
MAC_HOT Expr_Node *
expr_const_new(Arena *arena, Location loc, Lit_Value value)
{
	Expr_Const *node = EXPR_NEW(Expr_Const, EXPR_CONST, loc);
	node->value = value;
	return (Expr_Node *)node;
}
...
//
//		case EXPR_MATCH:
//			return (Expr_Node *)expr_const_copy(arena, node);
//
//		case EXPR_LET:
//			return (Expr_Node *)expr_const_copy(arena, node);
//
...
//			return (Expr_Node *)expr_const_copy(arena, node);
//
//		case EXPR_CONST: return (Expr_Node *)expr_const_copy(arena, node);
//	}
//}
//
//MAC_HOT Expr_If *
...
//{
//	Expr_Const *copy = EXPR_COPY(Expr_Const);
...
//
//MAC_HOT Expr_Const *
//expr_const_copy(Arena *arena, Expr_Const *node)
//{
//	Expr_Const *copy = EXPR_COPY(Expr_Const);
//	copy->value = node->value;
//	return copy;
