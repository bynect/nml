...
#define TAB_DECL(name, type, key, value) 												\
	...
	type ## _Tab_Key name ## _key(const type ## _Tab *tab, const key k);				\
																						\
	void name ## _union(const type ## _Tab *tab, type ## _Tab *dest, Arena *arena);		\
																						\
	...
	MAC_HOT bool name ## _get_key(const type ## _Tab *tab,								\
									type ## _Tab_Key hk, value *v);						\
																						\
	MAC_HOT Tab_Result name ## _insert(type ## _Tab *tab, Arena *arena,					\
										key k, value v);								\
																						\
	MAC_HOT Tab_Result name ## _insert_key(type ## _Tab *tab, Arena *arena,				\
											type ## _Tab_Key hk, value v);				\
																						\
	MAC_HOT Tab_Result name ## _unique(type ## _Tab *tab, Arena *arena,					\
										key k, value v);								\
																						\
	MAC_HOT Tab_Result name ## _unique_key(type ## _Tab *tab, Arena *arena,				\
								type ## _Tab_Key hk, value v);							\
																						\
