...
#define STR_STATIC(str) 	((const Sized_Str) { str, MAC_STRLEN(str) })
#define STR_ZLEN(str) 		((const Sized_Str) { str, strlen(str) })
#define STR_WLEN(str, len) 	((const Sized_Str) { str, len })

#define STR_INIT(str)		{ str, MAC_STRLEN(str) }
