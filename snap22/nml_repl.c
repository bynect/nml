...
repl_eval(Arena *arena, Hash_Default seed, const Source src)
{
	...
	{
		type_tab_insert(&ctx, STR_STATIC("+"), type_iadd);
		type_tab_insert(&ctx, STR_STATIC("-"), type_isub);
		type_tab_insert(&ctx, STR_STATIC("*"), type_imul);
		type_tab_insert(&ctx, STR_STATIC("/"), type_idiv);
		type_tab_insert(&ctx, STR_STATIC("%"), type_irem);

		type_tab_insert(&ctx, STR_STATIC("+."), type_fadd);
		type_tab_insert(&ctx, STR_STATIC("-."), type_fsub);
		type_tab_insert(&ctx, STR_STATIC("*."), type_fmul);
		type_tab_insert(&ctx, STR_STATIC("/."), type_fdiv);
		type_tab_insert(&ctx, STR_STATIC("%."), type_frem);

		type_tab_insert(&ctx, STR_STATIC(">"), type_gt);
		type_tab_insert(&ctx, STR_STATIC("<"), type_lt);
		type_tab_insert(&ctx, STR_STATIC(">="), type_ge);
		type_tab_insert(&ctx, STR_STATIC("<="), type_le);
		type_tab_insert(&ctx, STR_STATIC("="), type_eq);
		type_tab_insert(&ctx, STR_STATIC("!="), type_ne);

		type_tab_insert(&ctx, STR_STATIC("&&"), type_and);
		type_tab_insert(&ctx, STR_STATIC("||"), type_or);

		type_tab_insert(&ctx, STR_STATIC("neg"), type_ineg);
		type_tab_insert(&ctx, STR_STATIC("fneg"), type_fneg);
		type_tab_insert(&ctx, STR_STATIC("not"), type_not);
