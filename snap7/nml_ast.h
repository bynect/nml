...
Ast_Node *ast_match_new(Arena *arena, Ast_Node *value, struct Ast_Match_Arm *arms, size_t len);
...
Ast_Node *ast_ident_new(Arena *arena, Sized_Str name);
...
Ast_Node *ast_const_new(Arena *arena, Const_Value value);
