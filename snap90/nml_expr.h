...
MAC_HOT Expr_Node *expr_constr_new(Arena *arena, Location loc, Sized_Str name, Expr_Node *value);

MAC_HOT Expr_Node *expr_tuple_new(Arena *arena, Location loc, Expr_Node **items, size_t len);

MAC_HOT Expr_Node *expr_lit_new(Arena *arena, Location loc, Lit_Value value);
...
//
//MAC_HOT Expr_Lit *expr_lit_copy(Arena *arena, Expr_Lit *node);
