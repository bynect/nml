...
#ifdef MAC_PREFETCH
#if defined(MAC_ARCHX86) || defined(MAC_ARCHX64)
#include <emmintrin.h>
...
#ifndef MAC_PREFETCH_ONCE
#define MAC_PREFETCH_ONCE(addr, rw) \
							do { } while (0)
#endif

#ifndef MAC_PREFETCH_CACHE
#define MAC_PREFETCH_CACHE(addr, rw) \
							do { } while (0)
#endif

#ifdef MAC_LIKELINESS
#ifdef __has_builtin
...
#define MAC_HIDDEN		__attribute__((visibility("hidden"))
#endif
...
#define MAC_CAST(type, ...)	((type)(__VA_ARGS__))
#define MAC_UNUSED(x)		MAC_CAST(void, x)
...
#define MAC_DATE			""
#else
#define MAC_DATE			__DATE__
#endif

#ifndef __TIME__
#define MAC_TIME			""
#else
#define MAC_TIME			__TIME__
#endif
