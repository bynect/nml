...
MAC_HOT Expr_Node *
expr_let_new(Arena *arena, Location loc, Sized_Str name, Type_Scheme hint, Expr_Node *value, Expr_Node *expr)
{
...
MAC_HOT Expr_Node *
expr_fun_new(Arena *arena, Location loc, Sized_Str name, Type_Scheme hint, Sized_Str *pars,
