...
#define INTR_CAST(node)			((Expr_Node *)&node)
#define INTR_DEF(str, ty) 						\
	(Expr_Ident) {								\
		.node = {								\
			.kind = EXPR_IDENT,					\
			.type = ty,							\
		...
		.name = { str, MAC_STRLEN(str) },		\
	}

static Expr_Node *intr_add = INTR_CAST(INTR_DEF("Intrinsic.add", TYPE_TAG(TAG_FUN, &fun_bint)));
static Expr_Node *intr_sub = INTR_CAST(INTR_DEF("Intrinsic.sub", TYPE_TAG(TAG_FUN, &fun_bint)));
static Expr_Node *intr_mul = INTR_CAST(INTR_DEF("Intrinsic.mul", TYPE_TAG(TAG_FUN, &fun_bint)));
static Expr_Node *intr_div = INTR_CAST(INTR_DEF("Intrinsic.div", TYPE_TAG(TAG_FUN, &fun_bint)));
static Expr_Node *intr_rem = INTR_CAST(INTR_DEF("Intrinsic.rem", TYPE_TAG(TAG_FUN, &fun_bint)));

static Expr_Node *intr_fadd = INTR_CAST(INTR_DEF("Intrinsic.fadd", TYPE_TAG(TAG_FUN, &fun_bfloat)));
static Expr_Node *intr_fsub = INTR_CAST(INTR_DEF("Intrinsic.fsub", TYPE_TAG(TAG_FUN, &fun_bfloat)));
static Expr_Node *intr_fmul = INTR_CAST(INTR_DEF("Intrinsic.fmul", TYPE_TAG(TAG_FUN, &fun_bfloat)));
static Expr_Node *intr_fdiv = INTR_CAST(INTR_DEF("Intrinsic.fdiv", TYPE_TAG(TAG_FUN, &fun_bfloat)));
static Expr_Node *intr_frem = INTR_CAST(INTR_DEF("Intrinsic.frem", TYPE_TAG(TAG_FUN, &fun_bfloat)));

static Expr_Node *intr_gt = INTR_CAST(INTR_DEF("Intrinsic.gt", TYPE_TAG(TAG_FUN, &fun_bcmp)));
static Expr_Node *intr_lt = INTR_CAST(INTR_DEF("Intrinsic.lt", TYPE_TAG(TAG_FUN, &fun_bcmp)));
static Expr_Node *intr_ge = INTR_CAST(INTR_DEF("Intrinsic.ge", TYPE_TAG(TAG_FUN, &fun_bcmp)));
static Expr_Node *intr_le = INTR_CAST(INTR_DEF("Intrinsic.le", TYPE_TAG(TAG_FUN, &fun_bcmp)));
static Expr_Node *intr_eq = INTR_CAST(INTR_DEF("Intrinsic.eq", TYPE_TAG(TAG_FUN, &fun_bcmp)));
static Expr_Node *intr_ne = INTR_CAST(INTR_DEF("Intrinsic.ne", TYPE_TAG(TAG_FUN, &fun_bcmp)));

static Expr_Node *intr_and = INTR_CAST(INTR_DEF("Intrinsic.and", TYPE_TAG(TAG_FUN, &fun_bbool)));
static Expr_Node *intr_or = INTR_CAST(INTR_DEF("Intrinsic.or", TYPE_TAG(TAG_FUN, &fun_bbool)));

static Expr_Node *intr_neg = INTR_CAST(INTR_DEF("Intrinsic.neg", TYPE_TAG(TAG_FUN, &fun_int)));
static Expr_Node *intr_fneg = INTR_CAST(INTR_DEF("Intrinsic.fneg", TYPE_TAG(TAG_FUN, &fun_float)));
static Expr_Node *intr_not = INTR_CAST(INTR_DEF("Intrinsic.not", TYPE_TAG(TAG_FUN, &fun_bool)));

static Expr_Node *intr_panic = INTR_CAST(INTR_DEF("Intrinsic.panic", TYPE_TAG(TAG_FUN, &fun_panic)));
