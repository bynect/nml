...
Ast_Node *ast_let_new(Arena *arena, Sized_Str name, Ast_Node *value, Ast_Node *expr);

Ast_Node *ast_fun_new(Arena *arena, const Sized_Str name, Sized_Str *pars, size_t len, Ast_Node *body, Ast_Node *expr);
...
Ast_Node *ast_type_new(Arena *arena, Sized_Str name, Sized_Str *vars, Type *types, size_t len);
