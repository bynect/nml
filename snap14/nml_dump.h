...
void dump_expr_unary(const Expr_Unary *node, uint32_t depth, bool last);
...
void dump_variable(const Variable *var);

void dump_instr(const Instr *instr);

void dump_instr_unary(Instr_Kind kind, Type type, Instr_Unary instr);

void dump_instr_binary(Instr_Kind kind, Type type, Instr_Binary instr);

void dump_instr_load(Type type, Instr_Load instr);

void dump_instr_store(Type type, Instr_Store instr);

void dump_instr_alloc(Type type, Instr_Alloc instr);

void dump_instr_elemof(Type type, Instr_Elemof instr);

void dump_instr_addrof(Type type, Instr_Addrof instr);

void dump_instr_br(Instr_Br instr);

void dump_instr_ret(Instr_Ret instr);

void dump_instr_call(Type type, Instr_Call instr);
