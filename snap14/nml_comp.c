...
static MAC_HOT Variable compiler_node(Compiler *comp, Expr_Node *node,
...
compiler_if(Compiler *comp, Expr_If *node, Var_Tab *ctx, Function *fun, Block **block)
{
	...
	Variable then = compiler_node(comp, node->b_then, ctx, fun, &b_then);

	Block *b_else = builder_block(&comp->build, fun, NULL);
	Variable m_else = compiler_node(comp, node->b_else, ctx, fun, &b_else);
...
static MAC_HOT inline Variable
compiler_match(Compiler *comp, Expr_Match *node, Var_Tab *ctx, Function *fun, Block **block)
{
...
static MAC_HOT inline Variable
compiler_let(Compiler *comp, Expr_Let *node, Var_Tab *ctx, Function *fun, Block **block)
{
	return VAR_ERR;
}

static MAC_HOT inline Variable
compiler_fun(Compiler *comp, Expr_Fun *node, Var_Tab *ctx, Function *fun, Block **block)
{
//	Function fun;
...
static MAC_HOT inline Variable
compiler_app(Compiler *comp, Expr_App *node, Var_Tab *ctx, Function *fun, Block **block)
{
...
static MAC_HOT inline Variable
compiler_ident(Compiler *comp, Expr_Ident *node, Var_Tab *ctx, Function *fun, Block **block)
{
	Variable var;
...
static MAC_HOT inline Variable
compiler_unary(Compiler *comp, Expr_Unary *node, Var_Tab *ctx, Function *fun, Block **block)
{
...
static MAC_HOT inline Variable
compiler_binary(Compiler *comp, Expr_Binary *node, Var_Tab *ctx, Function *fun, Block **block)
{
...
static MAC_HOT inline Variable
compiler_tuple(Compiler *comp, Expr_Tuple *node, Var_Tab *ctx, Function *fun, Block **block)
{
	compiler_error(comp, node->node.loc, STR_STATIC("Tuples not implemented"));
	return VAR_ERR;
}
...
compiler_node(Compiler *comp, Expr_Node *node, Var_Tab *ctx, Function *fun, Block **block)
{
	switch (node->kind)
	{
		case EXPR_IF:
