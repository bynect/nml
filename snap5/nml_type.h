...
MAC_HOT bool checker_infer_ast(Type_Checker *check, Ast_Module *ast, Error_List *err);

MAC_HOT bool checker_infer_node(Type_Checker *check, Expr_Node *node, Error_List *err);
