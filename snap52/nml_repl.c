...
repl_eval(Arena *arena, Hash_Default seed, Scheme_Tab *ctx, Expr_Tab *def, const Source src)
{
	...
	if (succ)
	{
		expr_tab_insert(def, STR_STATIC("+"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.add")));
		expr_tab_insert(def, STR_STATIC("-"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.sub")));
		expr_tab_insert(def, STR_STATIC("*"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.mul")));
		expr_tab_insert(def, STR_STATIC("/"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.div")));
		expr_tab_insert(def, STR_STATIC("%"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.rem")));

		expr_tab_insert(def, STR_STATIC("+."), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.fadd")));
		expr_tab_insert(def, STR_STATIC("-."), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.fsub")));
		expr_tab_insert(def, STR_STATIC("*."), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.fmul")));
		expr_tab_insert(def, STR_STATIC("/."), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.fdiv")));
		expr_tab_insert(def, STR_STATIC("%."), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.frem")));

		expr_tab_insert(def, STR_STATIC(">"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.gt")));
		expr_tab_insert(def, STR_STATIC("<"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.lt")));
		expr_tab_insert(def, STR_STATIC(">="), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.ge")));
		expr_tab_insert(def, STR_STATIC("<="), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.le")));
		expr_tab_insert(def, STR_STATIC("="), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.eq")));
		expr_tab_insert(def, STR_STATIC("!="), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.ne")));

		expr_tab_insert(def, STR_STATIC("&&"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.and")));
		expr_tab_insert(def, STR_STATIC("||"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.or")));

		expr_tab_insert(def, STR_STATIC("neg"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.neg")));
		expr_tab_insert(def, STR_STATIC("fneg"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.fneg")));
		expr_tab_insert(def, STR_STATIC("not"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.not")));

		expr_tab_insert(def, STR_STATIC("panic"), expr_ident_new(arena, LOC_ERROR(NULL), STR_STATIC("Intrinsic.panic")));
	...
	arena_reset(arena);
	arena_shrink(arena, ARENA_PAGE * 2);
}
