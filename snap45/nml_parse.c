...
parser_expr_let(Parser *parse, Expr_Node **node)
{
	...
	// TODO: Fix operator overloading
	//if (parser_match(parse, TOK_LPAR))
	//{
	//	if (parse->curr.kind >= TOK_PLUS && parse->curr.kind <= TOK_TILDE)
	//	{
	//		name = parse->curr.str;
	//	}
	//	else
	//	{
	//		parser_error(parse, STR_STATIC("Expected operator"), false);
	//	}
...
//static MAC_HOT void
//parser_decl_sig(Parser *parse, Decl_Node **node)
//{
//	Location loc = parse->prev.loc;
...
//	{
//		Type type = parser_type(parse);
//		*node = decl_sig_new(parse->arena, loc, name, type);
//	}
//	else
//	{
//		parser_error(parse, STR_STATIC("Expected `:` before signature declaration"), true);
//	}
//}
...
parser_decl(Parser *parse, Decl_Node **node)
{
	switch (parse->prev.kind)
	{
		...
		// TODO: Fix signature declarations
		//case TOK_IDENT:
		//	parser_decl_sig(parse, node);
		//	break;
