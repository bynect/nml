...
parser_expr_fun(Parser *parse, Expr_Node **node)
{
	...
	*node = expr_fun_new(parse->arena, loc, hint, name, pars, len, body, expr);
}
...
parser_expr_lambda(Parser *parse, Expr_Node **node)
{
	...
	*node = expr_lambda_new(parse->arena, loc, pars, len, body);
}
...
parser_decl_fun(Parser *parse, Decl_Node **node)
{
	...
	*node = decl_fun_new(parse->arena, loc, hint, name, pars, len, body);
}
