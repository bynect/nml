...
static inline void
lit_init(Lit_Value *lit, Lit_Kind kind, const void *value)
{
	lit->kind = kind;
	switch (kind)
	{
...
lit_new(Lit_Kind kind, const void *value)
{
	Lit_Value lit;
	lit_init(&lit, kind, value);
	return lit;
}

static MAC_CONST inline bool
lit_equal(Lit_Value lit1, Lit_Value lit2)
{
